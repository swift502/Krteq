...
An extended 5x12 keyboard with 2 extra keys. This design is intended for ortho layouts with a shifted number row, allowing for the placement of the delete and tilde keys above their usual spots. PCBs are designed in Kicad, case in Blender.

Krteq is a successor to [Krtkus](https://github.com/swift502/Krtkus), improving on many of the flaws and bringing everything together to create a more maintainable, better encapsulated and overall more complete product.
