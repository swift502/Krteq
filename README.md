...
> [!TIP]
> At this point, I recommend plugging the keyboard in and testing it works. If you find a problem, it's still very easy to test connectivity or swap out the Pico.
