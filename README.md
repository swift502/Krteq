...
Krteq is a successor to [Krtkus](https://github.com/swift502/Krtkus), learning from it's lessons to make this easier to build, more maintainable, better encapsulated and an overall more complete design.
