...
The **USB breakout board** is expected to match the Adafruit style USB-C breakout board with two M2.5 screw holes 15.24mm apart, 2.54mm from the front edge.
