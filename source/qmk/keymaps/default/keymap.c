...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_default(
        ...
        KRT_RGB, RM_SATD, RM_VALU, RM_SATU, RM_SPDU, _______, _______, _______, _______, KC_PSLS, KC_PAST, KC_PMNS,
        _______, RM_HUED, RM_VALD, RM_HUEU, RM_SPDD, _______, _______, _______, _______, _______, _______, KC_PPLS,
